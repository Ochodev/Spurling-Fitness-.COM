...
export const metadata = generatePageMetadata({
  title: "SWEAT HIIT Workout Classes in Maine",
  ...
  return (
    <>
      <Hero
        ...
        headline="HIIT Workout Classes in Kennebunk, Scarborough & South Portland"
      ...
      <section className="bg-[#f5f5f5] py-16 sm:py-20">
        <Container>
          ...
          <p className="mx-auto mb-10 max-w-2xl text-center text-brand-gray">
            SWEAT HIIT workout classes are offered at every Spurling Fitness location across Southern Maine.
          </p>
          <div className="grid gap-6 sm:grid-cols-3">
            {locations.map((loc) => (
              <Link
                key={loc.id}
                href={`/what-we-do/sweat-hiit-workout-classes/${loc.id}/`}
