...
export const metadata = generatePageMetadata({
  title: "Private One-on-One Personal Training in Maine",
  ...
  return (
    <>
      <Hero
        ...
        headline="Private Personal Training in Kennebunk, Scarborough & South Portland"
      ...
      <section className="bg-[#f5f5f5] py-16 sm:py-20">
        <Container>
          ...
          <p className="mx-auto mb-10 max-w-2xl text-center text-brand-gray">
            Private one-on-one personal training is offered at every Spurling Fitness location across Southern Maine.
          </p>
          <div className="grid gap-6 sm:grid-cols-3">
            {locations.map((loc) => (
              <Link
                key={loc.id}
                href={`/what-we-do/private-one-on-one/${loc.id}/`}
